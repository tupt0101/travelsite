                    ...
                    <div class="inner">
                        ...
                        <form action="Login" method="POST">
                            ...
                            <div class="form-wrapper">
                                <input type="text" name="username" placeholder="Email Address" class="form-control" required oninvalid="this.setCustomValidity('Username is required!')">
                                <i class="zmdi zmdi-email"></i>
                            </div>
                            <div class="form-wrapper">
                                <input type="password" name="password" placeholder="Password" class="form-control" required oninvalid="this.setCustomValidity('Password is required!')">
                            ...
                            <br>Create a new account <a href="registration.jsp">here</a>
                        </form>
                    </div>
                </div>
