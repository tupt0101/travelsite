    ...
    <body>
        ...
        <section class="post-content-area single-post-area">
            <div class="container">
                <div class="row">
                    <div class="tab">
                        <button class="tablinks" onclick="openLink('profile.jsp')" id="defaultOpen"> <a class="fa fa-user"></a>&emsp;Profile</button>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                ...
                                <table style="width: 100%; height: 250px; color: black;">
                                    <tr>
                                        <td>Fullname:</td>
                                        <td> <s:property value="%{#session.CUSTOMER.customerName}"/> </td>
                                    </tr>
                                    <tr>
                                        <td>Email:</td>
                                        <td><s:property value="%{#session.CUSTOMER.mail}"/></td>
                                    </tr>
                                    <tr>
                                        <td>Phone number:</td>
                                        <td><s:property value="%{#session.CUSTOMER.phone}"/></td>
                                    </tr>
                                    <tr>
                                        <td>Gender:</td>
                                        <td><s:property value="%{#session.CUSTOMER.sex}"/></td>
                                    </tr>
                                    <tr>
                                        <td>Date of birth:</td>
                                        <td><s:property value="%{#session.CUSTOMER.dob}"/></td>
                                    </tr>
                                </table>
                            </div>
                            ...
                            <div class="col-lg-6">
                                ...
                                <table style="width: 100%; height: 50px; color: black;">
                                    <tr>
                                        <td>Address:</td>
                                        <td><s:property value="%{#session.CUSTOMER.address}"/></td>
                                    </tr>

                                </table>
                            </div>
                        </div> 
                        <button class="genric-btn info" onClick="openLink('edit-profile.jsp')">Edit profile</button>
                    </div>
