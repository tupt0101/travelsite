                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="holiday" role="tabpanel" aria-labelledby="holiday-tab">
                                <form class="form-wrap" action="SearchTour" method="POST">
                                    <input type="text" class="form-control" name="search" placeholder="Departure " onfocus="this.placeholder = ''" onblur="this.placeholder = 'Departure '">									
                                    <input type="text" class="form-control" name="to" placeholder="Arrival " onfocus="this.placeholder = ''" onblur="this.placeholder = 'Arrival '">
