            ...
            <div class="container">
                <div class="row">
                    <div class="tab">
                        ...
                        <button class="tablinks" onclick="openLink('edit-profile.jsp')" id="defaultOpen"> <a class="fa fa-cog"></a>&emsp;Edit information</button>
                    ...
                    <div id="Edit" class="tabcontent">
                        ...
                        <form action="UpdateProfile" method="POST" style="width: 100%;">
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-wrapper" style="margin: 5px 0px;">
                                        <span>Fullname</span>
                                        <input type="text" name="customerName" value="<s:property value="%{#session.CUSTOMER.customerName}"/>" class="form-control">
                                        <i class="zmdi zmdi-lock"></i>
                                    </div>
                                    <div class="form-wrapper" style="margin: 5px 0px;">
                                        <span>Phone number</span>
                                        <input type="text" name="phone" value="<s:property value="%{#session.CUSTOMER.phone}"/>" class="form-control">
                                        <i class="zmdi zmdi-lock"></i>
                                    </div>
                                    <div class="form-wrapper" style="margin: 5px 0px;">
                                        <span>Gender</span>
                                        <select name="sex" style="width: 100%; height: 40px;">
                                            <option value="Male" selected="%{#session.CUSTOMER.sex.equal('Male') : true}">Male</option>
                                            <option value="Female" selected="%{#session.CUSTOMER.sex.equal('Female') : true}">Female</option>
                                        </select>
                                    </div>
                                    <div class="form-wrapper" style="margin: 5px 0px;">
                                        <span>Date of birth (dd/mm/yyyy)</span>
                                        <input type="text" name="dob" value="<s:property value="%{#session.CUSTOMER.dob}"/>" class="form-control">
                                        <i class="zmdi zmdi-lock"></i>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-wrapper" style="margin: 5px 0px;">
                                        <span>Address</span>
                                        <input type="text" name="address" value="<s:property value="%{#session.CUSTOMER.address}"/>" class="form-control">
                                        <i class="zmdi zmdi-lock"></i>
                                    </div>
                                </div>
                                <input type="hidden" name="customerID" value="<s:property value="%{#session.CUSTOMER.customerID}"/>"/>
